...
public class Movimiento {
	...
	/**
	 * Se encarga de devolver el valor del atributo info que se corresponde la
	 * información que representa el movimiento.
	 * 
	...
	/**
	 * Se encarga de modificar el valor del atributo info que se corresponde con la
	...
	/**
	 * Se encarga de devolver el valor del atributo monederoActual que se
	 * corresponde con el valor monetario actual del monedero del usuario al que le
	 * corresponde el movimiento determinado.
	 * 
	 * @return monederoActual El valor monetario actual del monedero del usuario al
	...
	/**
	 * Se encarga de modificar el valor del atributo monederoActual que se
	 * corresponde con el el valor monetario actual del monedero del usuario al que
	 * le corresponde el movimiento determinado.
	 * 
	 * @param monederoActual El nuevo valor monetario actual del monedero del
	 *                       usuario a asignar al movimiento.
	 */
	...
	/**
	 * Se encarga de devolver el valor del atributo valor que se corresponde con el
	 * valor monetario realizado debido al movimiento.
	 * 
	...
	/**
	 * Se encarga de modificar el valor del atributo valor que se corresponde con el
	 * valor monetario realizado debido al movimiento.
	 * 
	...
	/**
	 * Se encarga de devolver el valor del atributo fecha que se corresponde con la
	 * fecha en la que se ha generado el movimiento o con la fecha del Bingo.
	 * 
	 * @return fecha La fecha en la que se ha generado el movimiento o la fecha del
	 *         Bing.
	 */
	...
	/**
	 * Se encarga de modificar el valor del atributo fecha que se corresponde con la
	...
	/**
	 * Devuelve una representación en cadena del objeto Movimiento, mostrando sus
	 * atributos.
	 *
