...
public class Usuario implements Comparable, Serializable {
	...
	/**
	 * Se encarga de modificar el valor del atributo monedero que se corresponde con
	 * el saldo monetario del usuario.
	 * 
	...
	/**
	 * Se encarga de modificar el valor del atributo numBingos que se corresponde
	 * con el número de veces que el usuario ha cantado Bingo.
	 * 
	...
	/**
	 * Se encarga de modificar el valor del atributo numEspeciales que se
	 * corresponde con el número de veces que el usuario ha cantado Especial.
	 * 
	 * @param numEspeciales El nuevo número de veces que el usuario ha cantado
	 *                      Especial.
	 */
	...
	/**
	 * Se encarga de modificar el valor del atributo numLineas que se corresponde
	 * con el número de veces que el usuario ha cantado Linea.
	 * 
	...
	/**
	 * Se encarga de modificar el valor del atributo cartonesHist que se corresponde
	 * con el historial de cartones del usuario.
	 * 
	...
	/**
	 * Se encarga de modificar el valor del atributo historico que se corresponde
	 * con la lista de movimientos que afectan al saldo del usuario.
	 * 
